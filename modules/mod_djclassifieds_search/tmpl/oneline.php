...
<form action="<?php echo JRoute::_($itemid_url.'&Itemid='.$itemid.'&se=1');?>" method="get" name="form-search<?php echo $module->id?>" id="form-search<?php echo $module->id?>">
			...
			if($params->get('show_price','1')==1){	?>
				<div class="search_price djcf_se_row">
					...
					<input size="5" class="inputbox" type="text" name="se_price_f" value="<?php echo JRequest::getVar('se_price_f',''); ?>" 
							placeholder="<?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_PRICE_FROM')?>" />
					...
					<input size="5" class="inputbox" type="text" name="se_price_t" value="<?php echo JRequest::getVar('se_price_t',''); ?>" 
							placeholder="<?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_PRICE_TO')?>" />
				</div>
		<?php }?>
	...
	<div class="search_row2" style="display: none;">
		...
		<?php if($params->get('show_only_price_negotiable','0')==1 || $params->get('show_only_auctions','0')==1 || $params->get('show_only_buynow','0')==1 || $params->get('show_only_images','0')==1 || $params->get('show_only_video','0')==1 || $params->get('show_restriction_18','0')==1){	?>
...
<div class="search_advanced">
	<a class="search_open"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_ADVANCED_SEARCH')?></a>
	<a class="search_close"><?php echo JText::_('MOD_DJCLASSIFIEDS_SEARCH_ADVANCED_CLOSE')?></a>
</div>
