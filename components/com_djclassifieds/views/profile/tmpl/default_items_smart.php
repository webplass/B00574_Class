			...
			<div class="dj-items_order_by">
				<div class="dj-items_order_by_in">
					<div class="dj-items_order_by_label"><?php echo JText::_('COM_DJCLASSIFIEDS_SORT_BY')?></div>															
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=title&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=cat&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=loc&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=price&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_a&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=date_sort&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
						...
						<a class="<?php echo $sort_class; ?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=display&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
							<?php echo JText::_('COM_DJCLASSIFIEDS_DISPLAYED'); ?>
						</a>	
						<?php if($par->get('column_distance','0')){ ?>
							<span class="item_orderby_separator"></span>
							<a class="<?php if($order=="distance"){ echo "active";}?>" href="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.'&order=distance&ord_t='.$ord_t.'&Itemid='.$Itemid,false);?>">
								...
								<?php if($par->get('column_image','1')){ ?>
										<div class="item_img_box" >
											<div class="item_img_box_in">					
												<a href="<?php echo DJClassifiedsSEO::getItemRoute($i->id.':'.$i->alias,$i->cat_id.':'.$i->c_alias,$i->region_id.':'.$i->r_name).$anch; ?>">
													<?php 
													if(count($i->images)){
																...
																if($this->custom_fields[$cf_active_all[$cf_i]]->type=='checkbox'){
																	...
																	if($i->fields[$cf_active_all[$cf_i]]==''){echo '---'; }
																		...
																		if($par->get('cf_values_to_labels','0')){
																			echo JText::_('COM_DJCLASSIFIEDS'.str_ireplace(' ', '_', strtoupper($i->fields[$cf_active_all[$cf_i]])));
																		}else{
