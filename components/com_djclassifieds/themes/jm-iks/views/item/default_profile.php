			...
			<div class="row_value">
				...
				if($item->user_id==0){
					...
					<div class="profile_item_box">
						<?php 							
							echo '<a class="profile_img" href="index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.DJClassifiedsSEO::getUserProfileItemid().'">';
						...
						<div class="profile_name_data">
							<?php echo '<a title="'.JText::_('COM_DJCLASSIFIEDS_SEE_ALL_USER_ADVERTS').'" class="profile_name" href="index.php?option=com_djclassifieds&view=profile&uid='.$uid_slug.DJClassifiedsSEO::getUserProfileItemid().'">';
