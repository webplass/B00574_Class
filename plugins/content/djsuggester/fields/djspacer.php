...
class JFormFieldDJSpacer extends JFormFieldSpacer
{
    ...
    {
    	$module = 'plg_content_suggester';
    	
    	if($module) {
	    	$lang = JFactory::getLanguage();
			$lang->load($module, JPATH_ROOT, 'en-GB', true, false);
	    	$lang->load($module, JPATH_ROOT . '/plugins/content/djsuggester', 'en-GB', true, false);
	    	$lang->load($module, JPATH_ROOT, null, true, false);
	    	$lang->load($module, JPATH_ROOT . '/plugins/content/djsuggester', null, true, false);
    	}
