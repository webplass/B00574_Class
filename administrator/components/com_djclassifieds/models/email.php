...
class DJClassifiedsModelEmail extends JModelAdmin
{

	public function getTable($type = 'Emails', $prefix = 'DJClassifiedsTable', $config = array())
	{
    ...
    function getElement() {
            ...
            $query = "SELECT * FROM #__djcf_emails WHERE id='$id'";
