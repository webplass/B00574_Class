<?php
/**
 * @version $Id: team.php 3 2017-01-26 15:01:21Z szymon $
 * @package DJ-Events
...
class DJClassifiedsModelGhostAd extends JModelAdmin
{
	
	public function getTable($type = 'GhostAds', $prefix = 'DJClassifiedsTable', $config = array())
	{
