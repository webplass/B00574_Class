...
{ 
	...
	{				
	    ...
	    $this->profile_fields = $this->get('ProfileFieldsSelect');
	    $this->categories_options = $this->get('CategoriesOptions');
	    if($this->field->id){
	    	$this->fields_groups = $model->getFormGroups($this->field->source);
	    }	    
