...
<form action="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=shippings&layout=payments&tmpl=component');?>" method="post" name="adminForm" id="adminForm">
	<div class="filter-select fltrt">
		<button type="button" onclick="javascript:Joomla.submitbutton('payments.assign')"><?php echo JText::_('JAPPLY'); ?></button>
		<button type="button" onclick="javascript:Joomla.submitbutton('payments.assignclose')"><?php echo JText::_('JSAVE'); ?></button>
