...
<form action="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=fieldgroup&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="fieldgroup-form" class="form-validate" enctype="multipart/form-data">
