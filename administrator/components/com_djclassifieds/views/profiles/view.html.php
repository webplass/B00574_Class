...
class DjClassifiedsViewProfiles extends JViewLegacy
{
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_DJCLASSIFIEDS_USERS_PROFILES'), 'generic.png');
		...
		if ($user->authorise('core.admin', 'com_djclassifieds')) {
			if($par->get('store_org_img','1')==1){
				JToolBarHelper::custom('profiles.recreateAvatarts','move','move',JText::_('COM_DJCLASSIFIEDS_RECREATE_AVATARS'),true,true);
			}
		}
