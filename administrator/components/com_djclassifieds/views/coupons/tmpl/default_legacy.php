...
?>
<form action="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=coupons');?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="adminlist">
		<thead>
			<tr>
				...
				<th width="15%">
					<?php echo JHtml::_('grid.sort', 'COM_DJCLASSIFIEDS_COUPON_CODE', 'a.coupon_code', $listDirn, $listOrder); ?>
				</th>
				<th width="40%">
					<?php echo JText::_('COM_DJCLASSIFIEDS_DESCRIPTION'); ?>
				</th>				
				<th width="10%">
					<?php echo JHtml::_('grid.sort', 'COM_DJCLASSIFIEDS_USAGE_COUNT', 'a.usage_count', $listDirn, $listOrder); ?>
				</th>
				<th width="10%">
		...
		<?php foreach ($this->items as $i => $item) :
			...
			<tr class="row<?php echo $i % 2; ?>">
				...
				<td>
					<a href="<?php echo JRoute::_('index.php?option=com_djclassifieds&task=coupon.edit&id='.$item->id);?>">
