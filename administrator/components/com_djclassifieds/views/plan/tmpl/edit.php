...
<form action="<?php echo JRoute::_('index.php?option=com_djclassifieds&view=plan&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	<div class="row-fluid">
					...
					<div class="tab-content">
						<div class="tab-pane active" id="details">
							...
							<div class="control-group">
								...
								<div class="controls">		                			
		                    		<?php echo $this->form->getInput('groups_assignment'); ?>						
								</div>
							</div>
							<div class="control-group">
