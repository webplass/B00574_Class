<?php
/**
 * @version $Id: upload.php 104 2017-09-14 18:17:11Z szymon $
...
abstract class DJUploadHelper {
	...
	public static function getUploader($id = 'uploader', $settings = array()) {
		...
		$doc->addStyleSheet(JURI::root(true).'/administrator/components/com_djmediatools/lib/upload/jquery.ui.plupload/css/jquery.ui.plupload.css');
		JHTML::_('behavior.framework', true);
		$version = new JVersion;
		if (version_compare($version->getShortVersion(), '3.0.0', '<')) {
			$doc->addScript('//ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js');
			$doc->addScript(JURI::root(true).'/administrator/components/com_djmediatools/lib/upload/jquery.noconflict.js');
		} else {
		...
		$doc->addScript(JURI::root(true).'/administrator/components/com_djmediatools/lib/upload/plupload.full.js');
		$doc->addScript(JURI::root(true).'/administrator/components/com_djmediatools/lib/upload/jquery.ui.plupload/jquery.ui.plupload.js');
		...
		$js = "			
			jQuery(function(){
				...
				plupload.addI18n({
					'Select files' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_HEADER'))."',
					'Add files to the upload queue and click the start button.' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_DESC'))."',
					'Filename' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_FILENAME'))."',
					'Status' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_STATUS'))."',
					'Size' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_SIZE'))."',
					'Add Files' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_ADD_FILES'))."',
					'Stop current upload' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_STOP_CURRENT_UPLOAD'))."',
					'Start uploading queue' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_START_UPLOADING_QUEUE'))."',
					'Uploaded %d/%d files': '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_UPLOADED_N_FILES'))."',
					'N/A' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_NA'))."',
					'Drag files here.' : '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_DRAG_AND_DROP_TEXT'))."',
					'Stop Upload': '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_STOP_UPLOAD'))."',
					'Start Upload': '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_START_UPLOAD'))."',
					'%d files queued': '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_N_FILES_QUEUED'))."',
					'File extension error.': '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_EXT_ERROR'))."',
					'File size error.': '".addslashes(JText::_('COM_DJMEDIATOOLS_UPLOADER_SIZE_ERROR'))."'
				});
		";
			if($debug) $js .= "
				function eventlog() {
		...
		$html = '<div id="'.$id.'" data-root="'.JURI::root(true).'"><p>You browser doesn\'t support Gears, BrowserPlus, HTML5, Flash, Silverlight and even HTML4! Please upgrade your browser!</p></div>';
	...
	public static function upload() {
		...
		// Settings
		$targetDir = JPath::clean(JPATH_ROOT . '/media/djmediatools/upload');
		//$targetDir = 'uploads';
