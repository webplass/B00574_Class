 ...
 * @since  1.6
 */
class DJMessagesModelTemplate extends JModelAdmin
{
	/**
	 * Message
	 */
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'Template', $prefix = 'DJMessagesTable', $config = array())
	{
	...
	protected function loadFormData()
	{
		...
		$data = JFactory::getApplication()->getUserState('com_djmessages.edit.template.data', array());
